...
/**
 * Dacorp\CoreBundle\Entity\DacorpMedia
 *
 *
...
class DacorpMedia
{
     ...
     * Set user
     *
     * @param \Dacorp\CoreBundle\Entity\User $user
     * @return DacorpMedia
     */
    public function setUser(\Dacorp\CoreBundle\Entity\User $user = null)
    {
        $this->user = $user;
     ...
     * Get user
     *
     * @return \Dacorp\CoreBundle\Entity\User 
     */
