...
/**
 * Dacorp\CoreBundle\Entity\Address
 *
...
class Address
{
     ...
     * Set state
     *
     * @param Dacorp\CoreBundle\Entity\State $state
     */
    public function setState(\Dacorp\CoreBundle\Entity\State $state)
    {
        $this->state = $state;
    }
     ...
     * Get state
     *
     * @return Dacorp\CoreBundle\Entity\State
     */
