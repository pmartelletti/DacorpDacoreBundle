...
//src/Dacorp/CoreBundle/Entity/User.php
 ...
 * @ORM\Entity(repositoryClass="Dacorp\CoreBundle\Repository\UserRepository")
...
class User extends BaseUser
{
     ...
     * @var Address
     *
     * @ORM\ManyToOne(targetEntity="Dacorp\CoreBundle\Entity\Address",cascade={"persist"})
     ...
     *
     * @ORM\OneToOne(targetEntity="Dacorp\CoreBundle\Entity\UserStat",cascade={"persist"})
     ...
     * Set userStat
     *
     * @param \Dacorp\CoreBundle\Entity\UserStat $userStat
     * @return User
     */
    public function setUserStat(\Dacorp\CoreBundle\Entity\UserStat $userStat = null)
    {
     ...
     * Get userStat
     *
     * @return \Dacorp\CoreBundle\Entity\UserStat 
     */
     ...
     * Add pictures
     *
     * @param \Dacorp\CoreBundle\Entity\DacorpMedia $pictures
     * @return User
     */
    public function addPicture(\Dacorp\CoreBundle\Entity\DacorpMedia $pictures)
    {
     ...
     * @param \Dacorp\CoreBundle\Entity\DacorpMedia $pictures
     */
    public function removePicture(\Dacorp\CoreBundle\Entity\DacorpMedia $pictures)
    {
